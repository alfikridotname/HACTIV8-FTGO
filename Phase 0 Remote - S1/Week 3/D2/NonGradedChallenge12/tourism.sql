...
CREATE TABLE `bookings`  (
  ...
  CONSTRAINT `bookings_ibfk_2` FOREIGN KEY (`guest_id`) REFERENCES `guests` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of bookings
-- ----------------------------
INSERT INTO `bookings` VALUES (1, 1, '2023-09-10', '2023-09-15', 1, 1500.00);
INSERT INTO `bookings` VALUES (2, 1, '2023-10-05', '2023-10-10', 2, 1800.00);
INSERT INTO `bookings` VALUES (3, 1, '2023-11-20', '2023-11-25', 3, 1200.00);
...
-- Records of guests
-- ----------------------------
INSERT INTO `guests` VALUES (1, 'AL', 'FIKRI');
